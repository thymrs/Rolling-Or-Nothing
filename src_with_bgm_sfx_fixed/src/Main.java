...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // เสียง: ต่อ AudioManager เป็น listener อีกตัว
        AudioManager audio = new AudioManager();
        state.addGameEventListener(audio);

        // เปิดธีมตอนเข้าหน้าเกม (เดี๋ยวตอนเกมเริ่มจริง phase จะสลับเป็น GAMEPLAY)
        audio.ensureBgm(AudioManager.BgmTrack.MAIN);
