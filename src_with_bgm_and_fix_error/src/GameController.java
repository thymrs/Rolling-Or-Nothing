...
public class GameController implements ActionListener {
    ...
    private void initGame(GameConfig config) {
        ...
        // ตอนนี้ players ถูก set แล้ว -> ยิง phase ซ้ำอีกรอบเพื่อให้ listener (เช่น AudioManager) ได้รับ event
    ...
    private void processPhase() {
        ...
        switch (currentPhase) {
            ...
            case SELECTING_DESTINATION ->
                view.showPopup("You're on a Wolrd Tour! Please select your destination");
        }
