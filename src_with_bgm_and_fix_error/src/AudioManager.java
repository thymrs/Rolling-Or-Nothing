...
public class AudioManager implements GameEventListener {
    ...
    public enum BgmTrack {
        ...
        TRAVEL("audio/bgm/gameplay.wav", true), // ยังไม่มี travel แยก ใช้ gameplay ไปก่อน
        DANGER("audio/bgm/danger.wav", true),
        VICTORY("audio/bgm/victory.wav", false); // ปกติเพลงชนะไม่ต้อง loop (ถ้าจะให้ loop เปลี่ยนเป็น true)
